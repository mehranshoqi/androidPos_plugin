...
import 'package:android_pos/models/new_invoice_product.dart';
        ...
        body: Center(
          ...
          children: [
            ...
            ElevatedButton(
                onPressed: () async {
                  var bytes =
                      await rootBundle.load('assets/images/coffee_cup_64.png');
                  var logo = base64Encode(bytes.buffer.asUint8List());
                  List<NewInvoiceProduct> details = [];
                  details.add(NewInvoiceProduct(
                      '1', '2', 3, 5000, '343', '3434', "کتاب اول بسیار خوب"));
                  details.add(NewInvoiceProduct(
                      '1', '2', 1, 3000, '343', '3434', "کتاب دوم بسیار بد"));
                  var model = InvoiceReceiptParams(
                      tax: '222',
                      transportCost: '4000',
                      totalPayAmount: '18000',
                      invoiceNumber: '123',
                      date: '1401/11/24 8:51',
                      products: details,
                      customer: "فروشگاه کتاب دارسیس",
                      marketer:
                          "خیابان انقلاب بعد اذ آزادی پلاک ۹۸ تلفن ۴۴۵۶۲۷۸۳",
                      logo: logo);
